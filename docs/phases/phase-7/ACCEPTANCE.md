...
- **Verification:** run log / notebook cell + sample response headers
- **Priority:** Required
...
- **Expected:** Phase 7 allowed/forbidden rows added to `docs/phases/phase-6/CLAIM_INVENTORY.md` (or successor inventory)
...
AC-001–006 pass. Phase 8 may start.
